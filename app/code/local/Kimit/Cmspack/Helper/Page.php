 ...
 * Time: 4:40 PM
 */ 
class Kimit_Cmspack_Helper_Page extends Mage_Cms_Helper_Page {
     ...
     * @return boolean
     */
    public function renderPreview($action, $versionId = null)
    {
        return $this->_renderPreview($action, $versionId);
    }
     ...
     * @return boolean
     */
    protected function _renderPreview($action, $versionId, $renderLayout = true)
    {
